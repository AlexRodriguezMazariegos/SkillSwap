...
public class UsuarioServicioTest {
    ...
    void init() {
        ...
        usuario.setEmail("moha123@gmail.com");
        usuario.setPuestoEmpresa("puesto");*/
    ...
    void getUsuarios() {
        ...
        ArrayList<Usuario> Usuarios = usuarioServicio.getUsuarios();
    ...
    void getById() 
    {
        // Simulamos el comportamiento del repositorio para devolver un Optional con el partner1
        when(usuarioRepo.findById(id)).thenReturn(Optional.of(usuario));

        // Llamamos al método del servicio que queremos probar
        Optional<Usuario> Usuarios = usuarioServicio.getById(id);

        // Verificamos si el método del repositorio fue llamado correctamente
        verify(usuarioRepo).findById(id);

        // Verificamos si el objeto devuelto es el mismo que el objeto que esperamos obtener
    ...
    void updateById() 
    {
        ...
        // Llamamos al método del servicio que queremos probar
        Usuario updatedUsuario = usuarioServicio.updateByIdPut(usuario, id);
    ...
    {
        // Llamamos al método del servicio que queremos probar
        boolean isDeleted = usuarioServicio.deleteUsuario(id);
